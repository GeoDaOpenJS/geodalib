[geodalib](../../../modules.md) / [regression/src](../index.md) / LinearRegressionResult

# Type Alias: LinearRegressionResult

> **LinearRegressionResult**: `object`

Defined in: [regression/src/regression/linear-regression.ts:40](https://github.com/GeoDaCenter/geoda-lib/blob/3f9453a08cf3d7f96b1a0d65d18359804129d8d2/js/packages/regression/src/regression/linear-regression.ts#L40)
