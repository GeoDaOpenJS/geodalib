...
class BatchLISA {
 public:
  BatchLISA(int num_obs, GeoDaWeight* w, const std::vector<std::vector<bool> >& undefs, double significance_cutoff,
  ...
  virtual std::vector<uint64_t> CountLargerSA(int cnt, const std::vector<std::vector<double> >& permutedSA) = 0;
