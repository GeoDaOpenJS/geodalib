 ...
 *
 */
export declare function getGeometryCollectionFromBinaryGeometries(geometryType: BinaryGeometryType, binaryFeaturesChunks: BinaryFeatureCollection[], wasm: CustomEmbindModule): Promise<GeometryCollection | null>;
/**
 ...
 */
export declare function createPointCollectionFromBinaryFeatures(pointsArray: Array<BinaryFeatureCollection['points']>, wasm: CustomEmbindModule): PointCollection;
/**
 ...
 */
export declare function createLineCollectionFromBinaryFeatures(linesArray: Array<BinaryFeatureCollection['lines']>, wasm: CustomEmbindModule): LineCollection;
/**
 ...
 */
export declare function createPolygonCollectionFromBinaryFeatures(polygonsArray: Array<BinaryFeatureCollection['polygons']>, wasm: CustomEmbindModule): PolygonCollection;
