...
test('Test localMoran()', async (t) => {
  ...
  t.deepEqual(
    result.lagValues,
    [
      -0.6018754231938057, -0.6018754231938057, 0, 0.8025005642584077,
      0.9362506583014756, 0.8693756112799416,
    ]
  );
  t.deepEqual(
    result.lisaValues,
    [
      0.3622540250447227, 0.3622540250447227, 0, 0.8050089445438283,
      0.6887298747763864, 0.7558139534883721,
    ]
  );
